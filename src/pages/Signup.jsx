        ...
        {step === 1 ? (
          ...
          <>
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-8">
              <div className="flex gap-1.5 min-[375px]:gap-2 sm:gap-4 justify-center">
                {otp.map((digit, idx) => (
                  <input
                    key={idx}
                    id={`otp-${idx}`}
                    className="w-full max-w-[2.25rem] min-[375px]:max-w-[2.5rem] sm:max-w-[3.5rem] h-11 min-[375px]:h-12 sm:h-14 text-center text-xl sm:text-2xl font-bold rounded-lg border border-gray-200 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all"
                    type="text"
                    maxLength="1"
                    value={digit}
